	...
	<body>
		<sec:authorize access="hasRole('ROLE_USER')">
			...
			<div style="padding-top: 50px;
				...
				<form:form method="post" action="ueb_select" modelAttribute="uebForm" 
						    ...
						    <c:forEach items="${uebForm.uebCollection}" var="position" varStatus="status">
						        <div id="pos_${status.count}">
						        	<div class="control-group">
										...
										<div class="controls">				 
											<input type="radio" onclick="myFunction(${position.id})" value="Show alert box" name="selected"> ${position.positionName}
										</div>
									</div>								  
						        </div>
						    </c:forEach>
